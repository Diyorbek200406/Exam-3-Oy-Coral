...
const productWrapper = document.querySelector("section#products .container");
...
products.forEach((product) => {
  ...
  stats.appendChild(cardPrice);

  let cardRating = document.createElement("span");
  stats.appendChild(cardRating);

  let icon = document.createElement("i");

  icon.classList.add("fa-solid", "fa-star", "text-warning");

  cardRating.appendChild(icon);
  cardRating.append(`${product.rating.rate} / ${product.rating.count}`);

  productWrapper.prepend(col);
});
